...
<div class="pdf-container">
  ...
  <?php 
        ...
        $id = $_GET['id'];
		 $sql = "SELECT * FROM add_intro WHERE id=".$id;
        ...
        <center><audio  src="uploads/<?=$intro['audio_url']?>" type="audio/mp3" controls></audio></center>
        <h4>topic <?php echo "{$intro['topic']}" ?> running....</h4> <br>
         <?php } } ?>
  </div>
</div>
</center>
