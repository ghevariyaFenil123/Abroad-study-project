...
<body>
    ...
    <section class="showcase-area" id="showcase">
        <div class="showcase-container">
            <h1 class="main-title" id="home">Study In UK</h1>
    ...
    <section id="about">
        <div class="about-wrapper container">
            <div class="about-text">
                <h2>Discover United Kingdom</h2>
                <p class="small">The seat of one of the oldest and the most renowned education systems, globally.</p>
                <br>
                <p>The United Kingdom also called the UK, is a sovereign countryin Europe, comprising the territories of
                    England, Scotland, Wales, and Northern Ireland. The capital and the largest city of the UK is
                    London. It is home to some of the most prominent educational institutions in the world such as
                    University of Oxford, University of Cambridge, Imperial College London and King’s College London, to
                    name few. Degrees earned from the UK are globally recognized and valued by the employers.
                </p><br>
                <p>The sixth largest economy as of 2022, UK is also home to the touted financial capital of the world,
                    London. It is also one of the most highly globalized economies of the world, with people from all
                    walks of life, coming to London to kickstart their career. 26 of the world’s 500 largest companies
                    are headquartered in UK. A few fundamental factors like academic excellence, quality education,
                    shorter degree length, part-time work option during studies and attract Indian students to the UK.
                </p>
            </div>
            <div class="about-img">
                <img src="https://kananco-assests.s3.ap-south-1.amazonaws.com/website_v2/images/study-abroad/uk/uk-map.webp?w=750&q=75"
                    alt="food" />
            </div>
        </div>
    </section>
    ...
    <section id="University-list">
        ...
        <table class="content-table">
            ...
            <tbody>
                ...
                require_once("Connection.php");
                $sql = "SELECT * FROM tblukcollegelist";
